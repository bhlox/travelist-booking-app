...
function ClientBookingsPage({
  ...
  return (
    <div className="max-w-screen-2xl mx-auto p-4 dark:text-white h-full pt-24 ">
...
function ReviewsSection() {
  ...
  return (
    <section className="max-w-screen-2xl mx-auto px-4 py-16 md:py-24 space-y-12">
          ...
          {reviewsData.map((_, ind) => (
            <button
              ...
              className={cn(
                ...
                null,
                { "bg-purple-600 dark:bg-purple-600": ind + 1 === currentSlide }
              )}
            />
          ))}
        </div>
...
function FAQSection() {
  return (
    <section className="max-w-screen-2xl mx-auto px-4 py-16 space-y-12">
